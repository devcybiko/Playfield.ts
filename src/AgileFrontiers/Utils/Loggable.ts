...
export const LoggableBase = Loggable(Base);
export abstract class LoggableClass extends LoggableBase { };
export function Loggable<TBase extends Mixin>(_base: TBase) {
