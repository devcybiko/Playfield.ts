...
define("Graphics/Gfx", ["require", "exports", "Graphics/GfxParms", "Utils/index"], function (require, exports, GfxParms_1, Utils) {
    ...
    class Gfx {
        ...
        text(msg, x = 0, y = 0, gparms = this.gparms, w) {
        ...
        textRect(msg, x = 0, y = 0, w, h, gparms = this.gparms) {
            ...
            if (gparms.textAlign === GfxParms_1.GfxParms.CENTER)
                x += w / 2;
            this.text(msg, x + 1, y + 1, gparms);
        }
    ...
    * It has its own set of GfxParms (font, colors, x/y offset)`
    ...
    class Tile extends _Tile {
        constructor(name, parent, x, y, w, h, playfield = parent._playfield) {
            super();
            this._rightJustify = false;
            this.Tree(name, parent);
            if (w < 0) {
                this._rightJustify = true;
                w = -w;
            }
            this.Rect(x, y, w, h);
            this.Logger();
...
define("Playfield/MenuTile", ["require", "exports", "Playfield/Tile", "Utils/index", "Graphics/index"], function (require, exports, Tile_1, Utils_2, Graphics_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.MenuTile = exports._MenuTile = void 0;
    /**
     * The MenuTile has some special capabilities
     */
    class _MenuTile extends Tile_1.Tile {
    }
    exports._MenuTile = _MenuTile;
    ;
    ;
    (0, Utils_2.applyMixins)(_MenuTile, [Utils_2.Logger]);
    class MenuTile extends _MenuTile {
        ...
        draw() {
            ...
            gparms.textAlign = Graphics_2.GfxParms.CENTER;
            gparms.fontFace = Graphics_2.GfxParms.SANS_SERIF;
            gparms.fontStyle = Graphics_2.GfxParms.BOLD;
            let x = this.x;
            let y = this.y;
            let w = this.w;
            let h = this.h;
            this.gfx.textRect("File", x, y, w, h, gparms);
            gparms.textAlign = Graphics_2.GfxParms.LEFT;
            gparms.fontFace = Graphics_2.GfxParms.SANS_SERIF;
            gparms.fontStyle = Graphics_2.GfxParms.REGULAR;
            ...
            gparms.color = "gray";
            gparms.fontStyle = Graphics_2.GfxParms.ITALIC;
...
define("Playfield/Events/KeyboardDispatcher", ["require", "exports", "Utils/index", "Playfield/Events/KeyEvent"], function (require, exports, Utils_3, KeyEvent_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class KeyboardDispatcher {
        ...
        _ordinaryKey(keyEvent) {
            ...
            if (obj.OrdinaryKey(keyEvent))
                return true;
            if ((0, Utils_3.inclusive)("A", key, "Z"))
                return obj.UpperCase(keyEvent);
            else if ((0, Utils_3.inclusive)("a", key, "z"))
                return obj.LowerCase(keyEvent);
            else if ((0, Utils_3.inclusive)("0", key, "9"))
...
define("Playfield/Events/MouseDispatcher", ["require", "exports", "Utils/index", "Playfield/Events/MouseEvent"], function (require, exports, Utils_4, MouseEvent_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
*
*/ 
define("Playfield/Events/CanvasEventHandler", ["require", "exports", "Utils/index", "Playfield/Events/KeyboardDispatcher", "Playfield/Events/MouseDispatcher"], function (require, exports, Utils_5, KeyboardDispatcher_1, MouseDispatcher_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.CanvasEventHandler = void 0;
    class CanvasEventHandler {
        constructor(canvas, obj) {
            this._logger = new Utils_5.Logger();
            this._obj = obj;
...
define("Playfield/Abilities/TimerMixin", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("Playfield/Abilities/index", ["require", "exports", "Playfield/Abilities/DraggerMixin", "Playfield/Abilities/DraggableMixin", "Playfield/Abilities/SelectableMixin", "Playfield/Abilities/SelecterMixin", "Playfield/Abilities/PresserMixin", "Playfield/Abilities/PressableMixin", "Playfield/Abilities/ClickerMixin", "Playfield/Abilities/ClickableMixin", "Playfield/Abilities/HovererMixin", "Playfield/Abilities/HoverableMixin", "Playfield/Abilities/EditableMixin", "Playfield/Abilities/EditorMixin", "Playfield/Abilities/RepeatableMixin", "Playfield/Abilities/TimerMixin"], function (require, exports, DraggerMixin_1, DraggableMixin_1, SelectableMixin_1, SelecterMixin_1, PresserMixin_1, PressableMixin_1, ClickerMixin_1, ClickableMixin_1, HovererMixin_1, HoverableMixin_1, EditableMixin_1, EditorMixin_1, RepeatableMixin_1, TimerMixin_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Timer = exports.Repeatable = exports.Editor = exports.Editable = exports.Hoverable = exports.Hoverer = exports.Clickable = exports.Clicker = exports.Pressable = exports.Presser = exports.Selecter = exports.Selectable = exports.Draggable = exports.Dragger = void 0;
    ...
    Object.defineProperty(exports, "Timer", { enumerable: true, get: function () { return TimerMixin_1.Timer; } });
});
define("Playfield/RootTile", ["require", "exports", "Playfield/Tile", "Playfield/MenuTile", "Playfield/Abilities/index", "Playfield/Events/index", "Utils/index"], function (require, exports, Tile_2, MenuTile_1, Abilities_1, Events_1, Utils_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
     ...
     */
    class _RootTile extends Tile_2.Tile {
    }
    exports._RootTile = _RootTile;
    ;
    ;
    (0, Utils_6.applyMixins)(_RootTile, [Events_1.Keyboardable, Events_1.Mouseable, Abilities_1.Clicker, Abilities_1.Selecter, Abilities_1.Presser, Abilities_1.Dragger, Utils_6.Logger, Abilities_1.Editor, Abilities_1.Hoverer]);
    class RootTile extends _RootTile {
        ...
        MenuDown(mouseEvent) {
            if (this._menuTile)
                this.removeChild(this._menuTile);
            this._menuTile = new MenuTile_1.MenuTile("Menu", this, mouseEvent.x, mouseEvent.y, 100, 14);
            return true;
        }
        MenuUp(mouseEvent) {
            if (this._menuTile)
...
define("Playfield/Playfield", ["require", "exports", "Utils/index", "Graphics/index", "Playfield/RootTile", "Playfield/Events/CanvasEventHandler"], function (require, exports, Utils_7, Graphics_3, RootTile_1, CanvasEventHandler_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ;
    ;
    (0, Utils_7.applyMixins)(_Playfield, [Utils_7.Logger, Utils_7.Rect]);
    class Playfield extends _Playfield {
        constructor(canvasId) {
            ...
            this._gfx = new Graphics_3.Gfx(this._ctx);
            this._gparms = new Graphics_3.GfxParms();
...
define("Playfield/index", ["require", "exports", "Playfield/Playfield", "Playfield/Tile", "Playfield/Abilities/DraggerMixin", "Playfield/Abilities/DraggableMixin"], function (require, exports, Playfield_1, Tile_3, DraggerMixin_2, DraggableMixin_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    Object.defineProperty(exports, "Tile", { enumerable: true, get: function () { return Tile_3.Tile; } });
...
define("Jed/Item", ["require", "exports", "Playfield/index", "Utils/index", "Playfield/Abilities/index", "Jed/ItemOptions"], function (require, exports, Playfield_2, Utils_8, Abilities_2, ItemOptions_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ;
    ;
    (0, Utils_8.applyMixins)(_Item, [Abilities_2.Draggable, Abilities_2.Selectable]);
...
define("Jed/ButtonItem", ["require", "exports", "Jed/Item", "Utils/index", "Playfield/Abilities/index"], function (require, exports, Item_1, Utils_9, Abilities_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ;
    ;
    (0, Utils_9.applyMixins)(_ButtonItem, [Abilities_3.Draggable, Abilities_3.Pressable, Abilities_3.Hoverable]);
...
define("Jed/LabelItem", ["require", "exports", "Jed/Item", "Utils/index", "Playfield/Abilities/index", "Graphics/index"], function (require, exports, Item_2, Utils_10, Abilities_4, Graphics_4) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ;
    ;
    (0, Utils_10.applyMixins)(_LabelItem, [Abilities_4.Draggable]);
    class LabelItem extends _LabelItem {
        ...
        draw() {
            ...
            if (this._rightJustify) {
                this.gparms.textAlign = Graphics_4.GfxParms.RIGHT;
                newX += this.w;
            }
...
define("Jed/TextItem", ["require", "exports", "Jed/Item", "Utils/index", "Playfield/Abilities/index"], function (require, exports, Item_3, Utils_11, Abilities_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ;
    ;
    (0, Utils_11.applyMixins)(_TextItem, [Abilities_5.Draggable, Abilities_5.Editable, Abilities_5.Timer]);
...
define("Jed/ToggleItem", ["require", "exports", "Jed/Item", "Utils/index", "Playfield/Abilities/index"], function (require, exports, Item_4, Utils_12, Abilities_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    ;
    ;
    (0, Utils_12.applyMixins)(_ToggleItem, [Abilities_6.Draggable, Abilities_6.Clickable, Abilities_6.Hoverable]);
...
define("Playfield/Shapes/BoxTile", ["require", "exports", "Playfield/Shapes/ShapeTile", "Utils/index", "Playfield/Abilities/index"], function (require, exports, ShapeTile_1, Utils_13, Abilities_7) {
    ...
    class BoxTile extends _BoxTile {
        constructor(name, parent, x, y, w, h) {
            ...
            this.DX = (0, Utils_13.random)(-10, 10);
            this.DY = (0, Utils_13.random)(-10, 10);
        }
        onGrab() {
            this.toFront();
            return true;
...
define("Test/BoxTestTile", ["require", "exports", "Playfield/index", "Utils/index"], function (require, exports, Playfield_3, Utils_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class BoxTestTile extends Playfield_3.Tile {
        constructor(name, parent, x, y, w, h = w) {
            ...
            this.DX = (0, Utils_15.random)(-10, 10);
            this.DY = (0, Utils_15.random)(-10, 10);
        }
        draw() {
            this._playfield.gfx.rect(this.x, this.y, this.w, this.h, this.gparms);
            this.tick();
...
define("Test/PlayfieldTest", ["require", "exports", "Playfield/index", "Test/CircleTestTile", "Test/BoxTestTile", "Utils/index", "Playfield/Shapes/index", "Jed/index"], function (require, exports, Playfield_4, CircleTestTile_1, BoxTestTile_2, Utils_16, Shapes_1, Jed_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class PlayfieldTest {
        ...
        jedTest() {
            ...
            let lablItem1 = new Jed_1.LabelItem("Label-1", parent, x - 110, y, -100, 14, "Label-1", "Label-1");
            let textItem2 = new Jed_1.TextItem("textitem-2", parent, x, y += 50, 100, 14, "Hello World 2");
            let lablItem2 = new Jed_1.LabelItem("Label-2", parent, x - 110, y, 100, 14, "Label-2", "Label-2");
